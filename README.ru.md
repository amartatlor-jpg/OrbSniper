...
Почти всегда виноват зависший процесс Discord, который держит отладочный порт. Жми **«Починить и перезапустить»** — программа закроет всё намертво, освободит порт и попробует заново. Если в консоли написано, что порт занят не Discord'ом — закрой ту программу.
